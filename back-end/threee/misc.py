"""
Various tool function for threee and scripts
"""
import gzip
import hashlib
import logging
...
from threee.constants import DECIMAL_PER_COIN_FALLBACK, DECIMALS_PER_COIN
...
def render_template(templatefile: str, arguments: dict = {}) -> str:
    ...
    env = Environment(
        loader=PackageLoader('threee', 'templates'),
