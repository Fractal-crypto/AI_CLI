...
from threee.constants import DATETIME_PRINT_FORMAT, LAST_BT_RESULT_FN, UNLIMITED_STAKE_AMOUNT
from threee.data.btanalysis import (calculate_csum, calculate_market_change,
                                       calculate_max_drawdown)
from threee.misc import (decimals_per_coin, file_dump_json, get_backtest_metadata_filename,
                            round_coin_value)
...
def generate_tag_metrics(tag_type: str,
    ...
    """
    주어진 태그 거래 및 결과 데이터 프레임에 대한 메트릭 목록을 생성하고 반환
    """
